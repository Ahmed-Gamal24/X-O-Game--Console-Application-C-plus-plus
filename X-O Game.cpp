...
char CheckWinner2(char Board2[5][5])
{
	...
	if (Board2[0][4] == Board2[1][3]     &&    Board2[1][3] == Board2[2][2]   && Board2[2][2] == Board2[3][1]    && Board2[3][1] == Board2[4][0]
		&& Board2[2][2] != ' ')
	{
		return Board2[0][2];
	}
...
void Play2()
{
	...
	if (gameOver != ' ')
	{
       ...
       // Function To Choose Dimention of X_O Game 
void chooseDimention()
{
	cout << "Choose\n";
